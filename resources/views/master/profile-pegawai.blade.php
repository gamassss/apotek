        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <input class="form-control" disabled type="text" id="" name="" value="{{ $user->username }}" autofocus />
                </div>
                <div class="mb-3 col-md-6">
                    <label for="" class="form-label">Name</label>
                    <input class="form-control" disabled type="text" id="" name="" value="{{ $user->name }}" autofocus />
                </div>
                <div class="mb-3 col-md-6">
                    <label for="" class="form-label">No Telepon</label>
                    <input class="form-control" disabled type="text" id="" name="" value="{{ $user->no_telpon }}" autofocus />
                </div>
                <div class="mb-3 col-md-6">
                    <label for="" class="form-label">Jabatan</label>
                    <input class="form-control" disabled type="text" id="" name="" value="{{ $user->jabatan }}" autofocus />
                </div>
            </div>
            </div>
        </div>
            ...
            <div class="card-body">
              <div class="mb-3 col-12 mb-0">
                <div class="alert alert-warning">
                  <h6 class="alert-heading fw-bold mb-1">Are you sure you want to reset passoword of this  account?</h6>
                  <p class="mb-0">Once you reset passoword of this  account, the password will be back to default settings.</p>
                </div>
              </div>
              <form method="POST" id="resetpassword" action="{{ route('pegawai.reset-password',['pegawai'=>$user->id]) }}">
                @csrf
                <button type="button" onclick="return confirm('resetpassword')" class="btn btn-danger deactivate-account">Reset Password</button>
              </form>
            </div>
          </div>
    </div>
