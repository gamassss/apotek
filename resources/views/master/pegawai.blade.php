                    ...
                    <div class="modal-body">
                        {{-- <div class="row">
                            <div class="col mb-3">
                                ...
                                <select name="nama_pegawai" class="select2" id="nama_pegawai">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" id="edit_nama_member" name="nama_member" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="edit_alamat_member" class="form-label">Alamat Member</label>
                                <input type="text" id="edit_alamat_member" name="alamat_member" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="edit_telpon_member" class="form-label">No Telpon Member</label>
                                <input type="text" id="edit_telpon_member" name="no_telpon" class="form-control" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
